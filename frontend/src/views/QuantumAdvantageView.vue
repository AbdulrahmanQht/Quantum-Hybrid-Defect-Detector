...
<template>
  <div
    :class="['transition-colors pb-16', isRtl ? 'text-right' : 'text-left']"
    :dir="isRtl ? 'rtl' : 'ltr'"
  >
    <!-- Hero -->
    ...
    <div
      v-else-if="qaData"
      class="px-4 mx-auto space-y-6 max-w-screen-2xl sm:px-6 lg:px-8"
    >
      <!-- Config Badges -->
      <div class="flex flex-wrap gap-3 mb-4 text-sm">
        ...
        <span class="qa-badge inline-flex items-center">
          <Atom
            class="w-3.5 h-3.5"
            :class="isRtl ? 'ml-1' : 'mr-1'"
          />{{ qaData.config.n_qubits }} {{ t('qa.qubits')
      ...
      <section class="qa-card">
        ...
        <div class="flex flex-wrap items-center gap-4 mb-6">
          ...
          <Info
            v-tooltip.top="t('qa.exp2.tooltip')"
            class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            style="color: var(--q-muted)"
          />
        </div>
        <div class="h-72">
      ...
      >
        ...
        <div class="h-72">
          <Chart
            type="line"
            :data="noiseChartData"
            :options="noiseChartOptions"
            class="w-full h-full"
          />
        </div>
        <div class="qa-note-green mt-4">
          <Info
            class="w-4 h-4 inline-block text-[#22C55E]"
            :class="isRtl ? 'ml-1' : 'mr-1'"
          />
          {{ t('qa.exp6.insight') }}
        </div>
      ...
      <section class="qa-card">
        <div class="qa-card-header">
          ...
          <Info
            v-tooltip.top="t('qa.exp1.tooltip')"
            class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
          />
        </div>
        <div class="flex flex-col items-center gap-8 md:flex-row">
          <div class="flex justify-center flex-1">
            ...
            >
              <path
                ...
                fill="none"
                stroke="var(--q-bar-border)"
                stroke-width="14"
                stroke-linecap="round"
              />
              <path
                :d="`M 20 130 A 90 90 0 0 1 ${halfGaugeX} ${halfGaugeY}`"
                fill="none"
                stroke="#22C55E"
                stroke-width="14"
                stroke-linecap="round"
          ...
          <div class="flex-1 space-y-3">
            ...
            <div
              v-if="Object.keys(featureOrthogonality).length > 1"
              class="flex gap-4 pt-2"
            >
              <div
                v-for="(val, model) in featureOrthogonality"
                :key="model"
                class="text-sm"
              >
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp13.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
        ...
        <section class="qa-card">
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp3.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
      ...
      <section class="qa-card">
        <div class="qa-card-header">
          ...
          <Info
            v-tooltip.top="t('qa.exp4.tooltip')"
            class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
          />
        </div>
            ...
            <div class="relative flex items-center justify-center">
              ...
              >
                ...
                <circle
                  ...
                  stroke="var(--q-teal)"
                  stroke-width="10"
                  :stroke-dasharray="circCircumference"
              ...
              >
                <span
                  class="text-2xl"
                  style="color: var(--q-text)"
                >{{ entanglementData.overall.toFixed(2) }}</span>
              </div>
            </div>
            <span
              class="text-sm"
              style="color: var(--q-muted)"
            >{{ t('qa.exp4.overallMean') }}</span>
          </div>
      ...
      <section class="qa-card">
        <div class="qa-card-header">
          ...
          <Info
            v-tooltip.top="t('qa.exp5.tooltip')"
            class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
          />
        </div>
            ...
            >
              ...
              >
                <template #body="{ data }">
                  <span
                    style="color: var(--q-text)"
                    :class="{ 'font-medium': data.highlight }"
                  >{{ data.model }}</span>
                  <Tag
                    v-if="data.highlight"
                    value="Baseline"
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        <section
          v-if="expressibilityData.length"
          class="qa-card"
        >
          <div class="qa-card-header">
            <div class="qa-icon-wrap">
            ...
            <Info
              v-tooltip.top="t('qa.exp7.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
          <div class="grid grid-cols-1 gap-4">
            <div
              v-for="d in expressibilityData"
              :key="d.model"
              class="qa-metric-card"
            >
              <div
        ...
        >
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp9.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
          <div class="grid grid-cols-1 gap-4">
            ...
            >
              ...
              <div class="mt-2">
                <Tag
                  :value="d.advantage ? t('qa.confirmed') : t('qa.notConfirmed')"
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp8.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
          <Card class="q-glass qa-inner-card">
              ...
              >
                ...
                <Column :header="t('qa.exp8.diff')">
                  <template #body="{ data }">
                    <span
                      class="font-mono"
                      :class="data.diff > 0 ? 'text-[#22C55E]' : 'text-[#F59E0B]'"
                    >{{ data.diff >
        ...
        >
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp10.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
          <Card class="q-glass qa-inner-card">
      ...
      >
        <div class="qa-card-header">
          ...
          <Info
            v-tooltip.top="t('qa.exp11.tooltip')"
            class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
          />
        </div>
        <div class="grid grid-cols-1 gap-4 sm:grid-cols-2">
          <div
            v-for="d in effectiveRankData"
            :key="d.model"
            class="qa-metric-card space-y-3 text-start"
          >
            <div
              class="text-sm font-medium"
              style="color: var(--q-text)"
            ...
            <div
              ...
              style="background: var(--q-bar-border)"
            >
              <div
                class="h-full rounded-full bg-[#6366F1]"
                :style="{ width: pct(d.zUtil) + '%' }"
              />
            </div>
            <div class="flex justify-between text-sm">
      ...
      <div class="grid grid-cols-1 gap-6 lg:grid-cols-2">
        ...
        >
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp12.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
          <div class="grid grid-cols-1 gap-4">
            <div
              v-for="d in intrinsicDimData"
              :key="d.model"
              class="qa-metric-card"
            >
              <div
        ...
        >
          <div class="qa-card-header">
            ...
            <Info
              v-tooltip.top="t('qa.exp14.tooltip')"
              class="w-4 h-4 flex-shrink-0 cursor-help qa-info-icon"
            />
          </div>
          <Card class="q-glass qa-inner-card">
