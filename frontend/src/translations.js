  ...
  EN: {
    ...
    benchmark: {
      ...
      charts: {
        ...
        radar_sub:         'Accuracy, F1, Precision, Recall and Noise Robustness across all three models',
        scatter_title:     'Accuracy vs Inference Latency',
        scatter_sub:       'One point per model — higher accuracy and lower latency is better',
        ...
        reliability_sub:   'Actual accuracy vs mean confidence at each noise level for the selected model',
        actual_acc_label:  'Actual Accuracy',
        confidence_label:  'Mean Confidence',
      },
      metrics: {
  ...
  AR: {
    ...
    benchmark: {
      ...
      charts: {
        ...
        accuracy_axis: "الدقة (%)",
        confidence_label: "ثقة النموذج",
        actual_acc_label: "الدقة الفعلية",
        radar_title:       'مقارنة متعددة المعايير',
        radar_sub:         'الدقة، F1، الضبط، الاسترجاع، ومتانة الضوضاء عبر النماذج الثلاثة',
        scatter_title:     'الدقة مقابل زمن الاستدلال',
        scatter_sub:       'نقطة واحدة لكل نموذج — الدقة الأعلى والزمن الأقل هو الأفضل',
        ...
        reliability_sub:   'الدقة الفعلية مقابل متوسط الثقة عند كل مستوى ضوضاء للنموذج المحدد',
        actual_acc_label:  'الدقة الفعلية',
        confidence_label:  'متوسط الثقة',
      },
      metrics: {
