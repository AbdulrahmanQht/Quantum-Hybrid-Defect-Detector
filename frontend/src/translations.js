...
export_json_success: 'Results exported to JSON successfully!',
    ...
    benchmark: {
      hero: {
        ...
        subtitle: 'Theme-aligned evaluation across clean accuracy, noise robustness, latency, and class diagnostics.',
        description:
          'This benchmark page compares the CNN baseline with the QNN CPU and QNN GPU variants using the same dataset setup, giving the team a consistent view of reliability and deployment tradeoffs.',
      ...
      performance: {
        ...
        description:
          'Accuracy, weighted F1, latency, and evaluated sample counts are grouped into quick comparison cards using the same visual language as the homepage.',
      ...
      latency: {
        ...
        description: 'Per-sample latency remains visible in both light and dark themes for fast deployment comparison.',
      },
      diagnostics: {
        eyebrow: 'Diagnostics',
...
export_json_success: 'تم تصدير النتائج إلى JSON بنجاح!',
    ...
    benchmark: {
      hero: {
        ...
        subtitle: 'واجهة متوافقة مع الثيم لعرض الدقة النظيفة وتحمل التشويش وزمن الاستدلال وتشخيص الفئات.',
        description:
      ...
      performance: {
        ...
        description:
          'تجمع البطاقات بين الدقة ودرجة F1 الموزونة وزمن الاستدلال وعدد العينات ضمن تنسيق بصري متوافق مع الصفحة الرئيسية.',
      ...
      latency: {
        ...
        description: 'يبقى زمن الاستدلال لكل عينة واضحاً في الوضعين الفاتح والداكن لتسهيل مقارنة جاهزية النشر.',
      },
      diagnostics: {
        eyebrow: 'التشخيص',
        title: 'تشخيص النموذج',
